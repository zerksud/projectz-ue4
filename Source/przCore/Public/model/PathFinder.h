...
namespace prz {
    namespace mdl {
        ...
        public:
            ...
            static PathCells FindPathBetweenCells(EDungeonCell::Type** map, ZWeight** mapCellWeight, int levelWidth, int levelHeight, const ZPosition& startCellPosition, const ZPosition& finishCellPosition, bool diggingIsAllowed = false);
